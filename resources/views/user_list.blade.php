...
<div class="container">
                                    ...
                                    <div class="row">
                                            ...
                                            <x-adminlte-datatable id="table_invoices" :heads="$heads_motos" striped hoverable with-buttons>
                                                    ...
                                                    <tr><td>{{ $user->name }}</td><td>{{ $user->email }}</td><td>{{ $user->role }}</td><td><a href=@php echo url("/user_edit_form?userid={$user->id}"); @endphp><button class="btn btn-xs btn-default text-primary mx-1 shadow" title="Edit">
